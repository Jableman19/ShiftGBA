...
//
//	Time-stamp: 2024-04-11, 14:22:58
...
#define floor_bn_gfxTilesLen 64
extern const bn::tile floor_bn_gfxTiles[2];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item floor(
            regular_bg_tiles_item(span<const tile>(floor_bn_gfxTiles, 2), bpp_mode::BPP_4, compression_type::NONE), 
            bg_palette_item(span<const color>(floor_bn_gfxPal, 16), bpp_mode::BPP_4, compression_type::NONE),
            regular_bg_map_item(floor_bn_gfxMap[0], size(32, 32), compression_type::NONE, 1, false));
}
