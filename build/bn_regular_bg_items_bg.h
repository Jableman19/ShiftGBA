...
//
//	Time-stamp: 2024-04-09, 13:03:02
...
#define bg_bn_gfxTilesLen 544
extern const bn::tile bg_bn_gfxTiles[17];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item bg(
            regular_bg_tiles_item(span<const tile>(bg_bn_gfxTiles, 17), bpp_mode::BPP_4, compression_type::NONE), 
